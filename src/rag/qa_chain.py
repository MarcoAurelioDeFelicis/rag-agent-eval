...
** Instruction **
Answer the user's question in a helpful and concise manner, based solely on your following context.
** Steps **
...
3. Generate an answer that follows these rules:
    - It must answer and translate the context in the same language as the user's question is.
    - It calls the context as YOUR "the recipe", "the recipes book", or similar.
...
4. Exceptions:
    - ONLY if the User Explicitly ask you suggestions or to "generate, create, invent" recipes, or similar, you can eventually use your prior knowledge of cooking, and take insipration from the contex, but the context is the main source.
...
Question: {input}
** End goal **
Provide a precise, language-consistent culinary response, strictly in the same lenguage of the Question.
"""),
